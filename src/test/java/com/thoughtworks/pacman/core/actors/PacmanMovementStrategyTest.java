...
public class PacmanMovementStrategyTest {
    ...
    public void shouldMaintainCurrentDirectionIfNextIsNotSpecified() throws Exception {
        ...
        PacmanMovementStrategy movementStrategy = new PacmanMovementStrategy(pacman, Direction.LEFT);
    ...
    public void shouldStopAndRememberPreviousDirectionIfNextInDesiredDirectionTileIsWall() throws Exception {
        ...
        assertThat(movementStrategy.getDirection(), equalTo(Direction.NONE));
        assertThat(movementStrategy.getPreviousDirection(), equalTo(Direction.LEFT));
    }
